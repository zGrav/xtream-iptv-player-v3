...
public class NSTPlayerSeriesActivity extends Activity implements OnClickListener {
    ...
    public static class Config implements Parcelable {
        public static final Creator<Config> CREATOR = new C21011();
        ...
        static class C21011 implements Creator<Config> {
            C21011() {
            }
        ...
        public void play(String url) {
            this.url = url;
            Intent intent = new Intent(this.activity, NSTPlayerSeriesActivity.class);
    ...
    public static void play(Activity context, String... url) {
        Intent intent = new Intent(context, NSTPlayerSeriesActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int opened_stream_id = getIntent().getIntExtra("VIDEO_ID", 0);
        ...
        String allowedFormat = getIntent().getStringExtra("EXTENSION_TYPE");
        this.mFilePath = "http://" + serverUrl + ":" + serverPort + "/series/" + username + "/" + password + "/";
        this.liveStreamDBHandler = new LiveStreamDBHandler(this);
        this.player = new NSTPlayerSeries(this);
